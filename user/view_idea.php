...
if ($user_id && $user_id != $project['user_id']) {
    ...
    $mutual_stmt->bind_param("ii", $project['user_id'], $user_id);
    $mutual_stmt->execute();
    ...
    $request_stmt->bind_param("iiii", $user_id, $project['user_id'], $project['user_id'], $user_id);
    ...
    $pending_stmt->bind_param("ii", $user_id, $project['user_id']);
