...
<script>
    function toggleProjectType() {
        document.getElementById("softwareOptions").classList.toggle("hidden", document.getElementById("projectType").value !== "software");
        document.getElementById("hardwareOptions").classList.toggle("hidden", document.getElementById("projectType").value !== "hardware");
    }
</script>
</body>
</html>
