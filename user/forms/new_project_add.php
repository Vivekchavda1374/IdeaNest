...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Updated SQL to include user_id, submission_date, and status
    $sql = "INSERT INTO projects (user_id, project_name, project_type, classification, description, language, image_path, video_path, code_file_path, instruction_file_path, submission_date, status) 
            VALUES ('$user_id', '$project_name', '$project_type', '$classification', '$description', '$language', '$image_path', '$video_path', '$code_file_path', '$instruction_file_path', '$submission_date', '$status')";
