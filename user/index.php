            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown user-dropdown">
                    <button class="btn btn-light dropdown-toggle d-flex align-items-center" type="button" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="me-2" style="width: 32px; height: 32px; border-radius: 50%; background-color: #4361ee; color: white; display: flex; align-items: center; justify-content: center; font-weight: bold;">
                            U
                        </div>
                        <span>User</span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="userMenu">
                        ...
                        <li><a class="dropdown-item text-danger" href="#"><i class="fas fa-sign-out-alt"></i> Sign Out</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="fw-medium">Database Migration</span>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="fw-medium">Content Strategy</span>
                        ...
                        <div>
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <span class="fw-medium">Backend API Development</span>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center p-3 border rounded mb-3">
                            <div class="me-3">
                                <div style="width: 45px; height: 45px; background-color: #4cc9f0; color: white; border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                        ...
                        <div class="d-flex align-items-center p-3 border rounded mb-3">
                            <div class="me-3">
                                <div style="width: 45px; height: 45px; background-color: #4361ee; color: white; border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                    <span style="font-size: 14px; font-weight: bold;">MAR</span>
                        ...
                        <div class="d-flex align-items-center p-3 border rounded">
                            <div class="me-3">
                                <div style="width: 45px; height: 45px; background-color: #f72585; color: white; border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                    <span style="font-size: 14px; font-weight: bold;">MAR</span>
                    ...
                    <div class="card-body p-0">
                        <div class="recent-activity">
                            <div class="item p-3">
                                ...
                                <div>
                                    <p class="mb-1">You commented on <span class="fw-medium">Mobile App Design</span></p>
                            ...
                            <div class="item p-3">
                                ...
                                <div>
                                    <p class="mb-1">You published a new blog <span class="fw-medium">UX Design Principles</span></p>
                            ...
                            <div class="item p-3">
                                ...
                                <div>
                                    <p class="mb-1">You completed <span class="fw-medium">Frontend Development</span> milestone</p>
                            ...
                            <div class="item p-3">
                                ...
                                <div>
                                    <p class="mb-1">Mentor session with <span class="fw-medium">Sarah Johnson</span> completed</p>
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                            <a href="#" class="list-group-item list-group-item-action p-3">
                                ...
                                <p class="text-muted small mb-2">Tips and tricks for optimizing React applications and improving performance.</p>
                            ...
                            <a href="#" class="list-group-item list-group-item-action p-3">
                                ...
                                <p class="text-muted small mb-2">Essential design concepts every developer should know about.</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="text-muted small">
                            ...
                            <a href="#" class="list-group-item list-group-item-action p-3">
                                ...
                                <p class="text-muted small mb-2">A comprehensive guide to building robust server-side applications.</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="text-muted small">
