            ...
            <div class="card-body">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="submission-info mb-4">
                        <i class="fas fa-info-circle me-2"></i> Submission Date and Time will be automatically recorded. You'll receive a confirmation number after successful submission.
                    </div>
