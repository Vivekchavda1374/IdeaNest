...
DROP TABLE IF EXISTS `idea_activity_log`;
...
DROP TABLE IF EXISTS `idea_collaborations`;
...
DROP TABLE IF EXISTS `idea_followers`;
...
DROP TABLE IF EXISTS `idea_ratings`;
...
DROP TABLE IF EXISTS `idea_shares`;
...
DROP TABLE IF EXISTS `idea_tag_relations`;
...
DROP TABLE IF EXISTS `idea_views`;
...
DROP TABLE IF EXISTS `mentoring_sessions_archive`;
...
DROP TABLE IF EXISTS `subadmin_activities`;
...
DROP TABLE IF EXISTS `subadmin_permissions`;
...
DROP TABLE IF EXISTS `subadmin_sessions`;
...
DROP TABLE IF EXISTS `user_follow_notifications`;
...
DROP VIEW IF EXISTS `idea_statistics`;
...
DROP VIEW IF EXISTS `message_share_statistics`;
...
DROP VIEW IF EXISTS `trending_ideas`;
...
DROP VIEW IF EXISTS `user_block_status`;
...
DROP VIEW IF EXISTS `user_follow_feed`;
